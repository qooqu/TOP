...
check version with: n`pm list <package name>`
...
npm puts all the dependency code in node_modules. your code wants to use ES6 moldules to access it with `import <package name>`. but browsers don't know how to connect `import` to node_modules
